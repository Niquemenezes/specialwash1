"""add created_at to salida

Revision ID: b3abd6e9b61d
Revises: 50c58917a996
Create Date: 2025-09-04 10:11:48.312357
...
revision = 'b3abd6e9b61d'
down_revision = '50c58917a996'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('salida', schema=None) as batch_op:
        batch_op.add_column(sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False))
